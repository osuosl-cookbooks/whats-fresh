...
default['whats_fresh']['access_log'] = Chef::DelayedEvaluator.new do
  "#{node['nginx']['log_dir']}/whats_fresh/access.log"
end
default['whats_fresh']['error_log'] = Chef::DelayedEvaluator.new do
  "#{node['nginx']['log_dir']}/whats_fresh/error.log"
end
